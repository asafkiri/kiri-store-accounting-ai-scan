...
נבדקים גם יצירת ספק וחשבונית באותה טרנזקציה, תחרות בין שמות ספקים שקולים, ושתי בקשות HTTP מקבילות לשמירה ולביטול של אותו mutationId. בביטול נבדק שהשמירה או הביטול מוכרעים דרך אותו receipt ב־Firestore, ושניסיון חוזר נותן את אותה הכרעה.
